...
![image-20221006084428894](./02What to do if my network fails to train.assets/image-20221006084428894.png)
...
![image-20221006084458358](./02What to do if my network fails to train.assets/image-20221006084458358.png)
...
![image-20221006084726856](./02What to do if my network fails to train.assets/image-20221006084726856.png)
...
![image-20221006084839506](./02What to do if my network fails to train.assets/image-20221006084839506.png)
...
![image-20221006085344937](./02What to do if my network fails to train.assets/image-20221006085344937.png)
...
​	![image-20221006085501225](./02What to do if my network fails to train.assets/image-20221006085501225.png)
...
![image-20221006184905816](./02What to do if my network fails to train.assets/image-20221006184905816.png)
...
![image-20221006185507277](./02What to do if my network fails to train.assets/image-20221006185507277.png)
...
![image-20221006185920408](./02What to do if my network fails to train.assets/image-20221006185920408.png)
...
![image-20221006190309057](./02What to do if my network fails to train.assets/image-20221006190309057.png)
...
![image-20221006190616376](./02What to do if my network fails to train.assets/image-20221006190616376.png)
...
![image-20221006190929971](./02What to do if my network fails to train.assets/image-20221006190929971.png)
...
![image-20221006191354277](./02What to do if my network fails to train.assets/image-20221006191354277.png)
...
![image-20221006191911471](./02What to do if my network fails to train.assets/image-20221006191911471.png)
...
![image-20221006192134697](./02What to do if my network fails to train.assets/image-20221006192134697.png)
...
![image-20221006192549467](./02What to do if my network fails to train.assets/image-20221006192549467.png)
...
![image-20221006192750086](./02What to do if my network fails to train.assets/image-20221006192750086.png)
...
![image-20221006193517728](./02What to do if my network fails to train.assets/image-20221006193517728.png)

![image-20221006193529950](./02What to do if my network fails to train.assets/image-20221006193529950.png)
...
![image-20221006193716807](./02What to do if my network fails to train.assets/image-20221006193716807.png)
...
![image-20221006193908375](./02What to do if my network fails to train.assets/image-20221006193908375.png)
...
![image-20221006194316973](./02What to do if my network fails to train.assets/image-20221006194316973.png)
...
- 第二项是$(θ-θ')^Tg$
  ...
  ![image-20221006194334404](./02What to do if my network fails to train.assets/image-20221006194334404.png) 
...
- 第三项跟Hessian有关,这边有一个$H $
  ...
  ![image-20221006194355412](./02What to do if my network fails to train.assets/image-20221006194355412.png)
...
![image-20221006194442074](./02What to do if my network fails to train.assets/image-20221006194442074.png)
...
![image-20221006194533615](./02What to do if my network fails to train.assets/image-20221006194533615.png)
...
y= w₁×w₂×x
$$
![image-20221006194811808](./02What to do if my network fails to train.assets/image-20221006194811808.png)	
...
![image-20221006194832040](./02What to do if my network fails to train.assets/image-20221006194832040.png)
...
![image-20221006194913012](./02What to do if my network fails to train.assets/image-20221006194913012.png)
...
![image-20221006194934650](./02What to do if my network fails to train.assets/image-20221006194934650.png)
...
![image-20221006195031733](./02What to do if my network fails to train.assets/image-20221006195031733.png)
...
![image-20221006195047354](./02What to do if my network fails to train.assets/image-20221006195047354.png)

假设我们这边v,代的是一个eigen vector,我们这边θ减θ',放的是一个eigen vector的话,会发现说我们这个红色的项裡面,其实就是λ‖u‖²

![image-20221006195312267](./02What to do if my network fails to train.assets/image-20221006195312267.png)
...
![image-20221006195358958](./02What to do if my network fails to train.assets/image-20221006195358958.png)
...
![image-20221006195601873](./02What to do if my network fails to train.assets/image-20221006195601873.png)

​	而经验上,如果你自己做一些实验的话,也支持这个假说

![image-20221006195620662](./02What to do if my network fails to train.assets/image-20221006195620662.png)
...
![image-20221006195822304](./02What to do if my network fails to train.assets/image-20221006195822304.png)
...
![image-20221006195905300](./02What to do if my network fails to train.assets/image-20221006195905300.png)
...
![image-20221006200042483](./02What to do if my network fails to train.assets/image-20221006200042483.png)
...
![image-20221006200133515](./02What to do if my network fails to train.assets/image-20221006200133515.png)
...
![image-20221006200221732](./02What to do if my network fails to train.assets/image-20221006200221732.png)
...
![image-20221006200244582](./02What to do if my network fails to train.assets/image-20221006200244582.png)
...
![image-20221006200344940](./02What to do if my network fails to train.assets/image-20221006200344940.png)
...
![image-20221006200413413](./02What to do if my network fails to train.assets/image-20221006200413413.png)
...
![image-20221006200448479](./02What to do if my network fails to train.assets/image-20221006200448479.png)
...
![image-20221006200517088](./02What to do if my network fails to train.assets/image-20221006200517088.png)
...
![image-20221006200704025](./02What to do if my network fails to train.assets/image-20221006200704025.png)
...
![image-20221006200758388](./02What to do if my network fails to train.assets/image-20221006200758388.png)
...
![image-20221006200836013](./02What to do if my network fails to train.assets/image-20221006200836013.png)
...
![image-20221006200849838](./02What to do if my network fails to train.assets/image-20221006200849838.png)
...
​	![image-20221006200953971](./02What to do if my network fails to train.assets/image-20221006200953971.png)
...
![image-20221006201007412](./02What to do if my network fails to train.assets/image-20221006201007412.png)
...
![image-20221006201100084](./02What to do if my network fails to train.assets/image-20221006201100084.png)
...
![image-20221006201109845](./02What to do if my network fails to train.assets/image-20221006201109845.png)
...
![image-20221006201125516](./02What to do if my network fails to train.assets/image-20221006201125516.png)
...
![image-20221006201310795](./02What to do if my network fails to train.assets/image-20221006201310795.png)
...
![image-20221006201349680](./02What to do if my network fails to train.assets/image-20221006201349680.png)
...
![image-20221006202947034](./02What to do if my network fails to train.assets/image-20221006202947034.png)
...
![image-20221006203023531](./02What to do if my network fails to train.assets/image-20221006203023531.png)
...
![image-20221006203044464](./02What to do if my network fails to train.assets/image-20221006203044464.png)
...
![image-20221006203220667](./02What to do if my network fails to train.assets/image-20221006203220667.png)
...
![image-20221006203307562](./02What to do if my network fails to train.assets/image-20221006203307562.png)
...
![image-20221006203335019](./02What to do if my network fails to train.assets/image-20221006203335019.png)
...
![image-20221006203453092](./02What to do if my network fails to train.assets/image-20221006203453092.png)
...
![image-20221006203719885](./02What to do if my network fails to train.assets/image-20221006203719885.png)

这个黑线是我们的error surface,从这个地方开始你要update参数,好你这个球就从这边走到这边,那因為一路上都很平坦,很平坦就代表说g算出来很小,代表现在update参数的时候,我们会走比较大的步伐

![image-20221006203729440](./02What to do if my network fails to train.assets/image-20221006203729440.png)
...
![image-20221006203758253](./02What to do if my network fails to train.assets/image-20221006203758253.png)
...
![image-20221006203811792](./02What to do if my network fails to train.assets/image-20221006203811792.png)
...
![image-20221006204246507](./02What to do if my network fails to train.assets/image-20221006204246507.png)
...
![image-20221006204348105](./02What to do if my network fails to train.assets/image-20221006204348105.png)
...
![image-20221006204542238](./02What to do if my network fails to train.assets/image-20221006204542238.png)
...
![image-20221006204616837](./02What to do if my network fails to train.assets/image-20221006204616837.png)
...
![image-20221006204637372](./02What to do if my network fails to train.assets/image-20221006204637372.png)
...
![image-20221006204846001](./02What to do if my network fails to train.assets/image-20221006204846001.png)
...
- 接下来应该要update多大的步伐呢,我们要除掉,gradient的Root Mean Square
  ...
  ![image-20221006205013246](./02What to do if my network fails to train.assets/image-20221006205013246.png)
...
- 那最后我们还会加上,一个learning rate的scheduling,
  ...
  ![image-20221006204944854](./02What to do if my network fails to train.assets/image-20221006204944854.png)
...
![image-20221006205036622](./02What to do if my network fails to train.assets/image-20221006205036622.png)

到目前為止呢 我们讲的是什麼,我们讲的是,当我们的error surface非常的崎嶇,就像这个例子一样非常的崎嶇的时候

![image-20221006205055175](./02What to do if my network fails to train.assets/image-20221006205055175.png)
...
![image-20221006210057693](./02What to do if my network fails to train.assets/image-20221006210057693.png)
...
![image-20221006210116258](./02What to do if my network fails to train.assets/image-20221006210116258.png)
...
![image-20221006210135523](./02What to do if my network fails to train.assets/image-20221006210135523.png)
...
![image-20221006210254968](./02What to do if my network fails to train.assets/image-20221006210254968.png)
...
![image-20221006210446484](./02What to do if my network fails to train.assets/image-20221006210446484.png)
...
![image-20221006210632043](./02What to do if my network fails to train.assets/image-20221006210632043.png)
...
![image-20221006210816969](./02What to do if my network fails to train.assets/image-20221006210816969.png)

所以每一个 x 都做类似的事情,但是如果我们进一步来想的话,对 $w_2$ 来说

![image-20221006210830979](./02What to do if my network fails to train.assets/image-20221006210830979.png)
...
![image-20221006210920261](./02What to do if my network fails to train.assets/image-20221006210920261.png)
...
![image-20221006211022265](./02What to do if my network fails to train.assets/image-20221006211022265.png)
...
![image-20221006211127438](./02What to do if my network fails to train.assets/image-20221006211127438.png)
...
![image-20221006211234897](./02What to do if my network fails to train.assets/image-20221006211234897.png)
...
![image-20221006211736443](./02What to do if my network fails to train.assets/image-20221006211736443.png)
...
![image-20221006211932440](./02What to do if my network fails to train.assets/image-20221006211932440.png)
...
![image-20221006212000439](./02What to do if my network fails to train.assets/image-20221006212000439.png)
...
![image-20221006212038708](./02What to do if my network fails to train.assets/image-20221006212038708.png)
...
![image-20221006212155682](./02What to do if my network fails to train.assets/image-20221006212155682.png)
...
![image-20221006212237916](./02What to do if my network fails to train.assets/image-20221006212237916.png)
...
![image-20221006212323321](./02What to do if my network fails to train.assets/image-20221006212323321.png)
